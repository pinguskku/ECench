commit 1aaa4da98ec2e7735fecf24faaf641450c3d69bb
...
index f99ab94b4..e92f08fe0 100644
...
index ad3ff132f..c30362c82 100644
...
index 730410ca0..c301294c3 100644
...
@@ -697,7 +695,7 @@ func opCreate(pc *uint64, interpreter *EVMInterpreter, contract *Contract, memor
 	var (
 		value        = stack.pop()
 		offset, size = stack.pop(), stack.pop()
...
@@ -731,7 +729,7 @@ func opCreate2(pc *uint64, interpreter *EVMInterpreter, contract *Contract, memo
 		endowment    = stack.pop()
 		offset, size = stack.pop(), stack.pop()
 		salt         = stack.pop()
-		input        = memory.Get(offset.Int64(), size.Int64())
...
@@ -763,7 +761,7 @@ func opCall(pc *uint64, interpreter *EVMInterpreter, contract *Contract, memory
...
@@ -792,7 +790,7 @@ func opCallCode(pc *uint64, interpreter *EVMInterpreter, contract *Contract, mem
 	toAddr := common.BigToAddress(addr)
 	value = math.U256(value)
...
+	args := memory.GetPtr(inOffset.Int64(), inSize.Int64())
 	...
 	if value.Sign() != 0 {
 		gas += params.CallStipend
@@ -820,7 +818,7 @@ func opDelegateCall(pc *uint64, interpreter *EVMInterpreter, contract *Contract,
...
+	args := memory.GetPtr(inOffset.Int64(), inSize.Int64())
 	...
 	if err != nil {
@@ -845,7 +843,7 @@ func opStaticCall(pc *uint64, interpreter *EVMInterpreter, contract *Contract, m
 	addr, inOffset, inSize, retOffset, retSize := stack.pop(), stack.pop(), stack.pop(), stack.pop(), stack.pop()
 	toAddr := common.BigToAddress(addr)
 	// Get arguments from the memory.
-	args := memory.Get(inOffset.Int64(), inSize.Int64())
+	args := memory.GetPtr(inOffset.Int64(), inSize.Int64())
 	...
 	if err != nil {
@@ -901,7 +899,7 @@ func makeLog(size int) executionFunc {
...
index 7ecc0f444..e85038c40 100644
...
index c3d6d5340..19ec9c9cc 100644
--- a/core/vm/memory.go
+++ b/core/vm/memory.go
...
index 9ad6e686c..7fdeb0ae0 100644
